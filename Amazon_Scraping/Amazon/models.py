...
class Amazon(models.Model):
    ...
    reviews = models.BigIntegerField(
        db_column='Reviews', blank=True, null=True)
    # Field name made lowercase.
    ...
    free_option = models.TextField(
        db_column='Free Option', blank=True, null=True)
    # Field name made lowercase. Field renamed to remove unsuitable characters.
    more_option = models.TextField(
        db_column='More Option', blank=True, null=True)
    # Field name made lowercase. Field renamed to remove unsuitable characters.
    more_prices = models.TextField(
        db_column='More Prices', blank=True, null=True)
    # Field name made lowercase.
